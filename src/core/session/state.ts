...
/** Presentation observer for receiver lifecycle changes after each valid transition. */
export type ReceiverStateHandler = (state: ReceiverState) => void;
...
export function transitionReceiverState(
